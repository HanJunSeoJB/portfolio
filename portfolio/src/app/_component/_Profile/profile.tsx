            ...
            <div className={style.grids}>
                <div className={style.container}>
                    <div className={style.hero}>   
                        <h1 className={`${notoSans.className} ${style.fadeUpItem}`} style={{animationDelay:"0s"}}>경험을 추구하는 개발자</h1>
                        <h1 className={`${notoSans.className} ${style.fadeUpItem}`} style={{animationDelay:"0s"}}>한준서입니다.</h1>
                        <Job/>
                        <p className={`${notoSans.className} ${style.fadeUpItem}`} style={{animationDelay:"0.2s"}}>작은 인터랙션 하나에도 사용자 입장에서 고민하며, 직관적이고 효율적인 UI를 설계하는 데 집중합니다.
                    ...
                    <div className={`${style.contact} ${style.fadeUpItem}`} style={{animationDelay:"0.4s"}}>
                        <ScrollButton/>
                        <ResumeDownloadButton/>
                    </div>
                    <div className={`${style.icons} ${style.fadeUpItem}`} style={{animationDelay:"0.6s"}}>
